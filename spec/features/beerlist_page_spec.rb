...
describe "beerlist page" do
  ...
  it "shows known beers in alphabetical order", :js => true do
    visit beerlist_path
    find('table').find('tr:nth-child(2)')
  ...
  it "when style is clicked, beers are re-arraged by style", :js => true do
    visit beerlist_path
  ...
  it "when brewery is clicked, beers are re-arraged by brewery", :js => true do
    visit beerlist_path
